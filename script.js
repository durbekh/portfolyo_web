...
const translations = {
    uz: {
        ...
        "github-link": "🔗 github.com/durbekh",
    ...
    ru: {
        name: "Дурбек Хайотбеков",
        title: "Full Stack Разработчик",
        "about-title": "О себе",
        "about-text": "Я разработчик, работающий в направлении backend. Меня интересует создание веб-приложений и работа с базами данных. В настоящее время изучаю IT и стремлюсь стать хорошим разработчиком. У меня хороший опыт в языке программирования Python и я знаю, как использовать фреймворки Flask и FastAPI. Работаю с SQLite и PostgreSQL для работы с базами данных.",
        "age-label": "Возраст:",
        "age-value": "Изучаю программирование",
        "location-label": "Местоположение:",
        "location-value": "Узбекистан",
        "education-label": "Образование:",
        "education-value": "Изучаю IT",
        "interest-label": "Интерес:",
        "interest-value": "Backend Разработка",
        ...
        "project1-title": "Telegram Бот",
        "project1-desc": "Простой telegram бот, который возвращает Telegram ID при отправке изображения.",
        "project2-title": "Книжный Бот",
        "project2-desc": "Бот для работы с книгами начального уровня.",
        "project3-title": "Алгоритмические Задачи",
        "project3-desc": "Репозиторий со всем моим кодом. Решение алгоритмических задач.",
        "github-title": "GitHub",
        "github-desc": "Все мои проекты находятся на GitHub. Посетите мой профиль и поставьте звезду!",
        "github-link": "🔗 github.com/durbekh",
        "repos-label": "Репозитории",
        "years-label": "Год Опыта",
        "experience-title": "Опыт",
        "exp1-date": "2024 - Настоящее время",
        "exp1-title": "Студент / Разработчик",
        "exp1-desc": "Изучаю backend программирование и создаю независимые проекты. Работаю с Python, Flask, FastAPI и базами данных.",
        "exp2-date": "2024",
        "exp2-title": "Создание Telegram Ботов",
        "exp2-desc": "Создал различные telegram боты с помощью фреймворка Aiogram. Книжный бот, бот для ID изображений и другие полезные боты.",
        "contact-title": "Контакты",
        "contact-me-title": "Свяжитесь со мной",
        "contact-text": "Если у вас есть вопросы или вы хотите сотрудничать, свяжитесь через Telegram, Gmail или GitHub. Я всегда открыт для новых проектов и сотрудничества!",
        "form-name-label": "Имя и Фамилия",
        "form-name-placeholder": "Ваше Имя и Фамилия",
        "form-email-label": "Email",
        "form-email-placeholder": "Ваш Email адрес",
        "form-subject-label": "Тема",
        "form-subject-placeholder": "О чем вы хотите написать?",
        "form-message-label": "Сообщение",
        "form-message-placeholder": "Напишите ваше сообщение...",
        "form-submit-btn": "Отправить",
        "telegram-label": "Telegram",
        "gmail-label": "Gmail",
        "github-label": "GitHub",
        "contact-note": "Все мои проекты и код видны на GitHub. Посетите мой профиль и поставьте звезду!",
        "profile-placeholder": "Добавить фото"
    }
};
...
class Particle {
    constructor(x, y) {
        ...
        this.size = Math.random() * 2.2 + 1.2; // 1.2px – 3.4px
